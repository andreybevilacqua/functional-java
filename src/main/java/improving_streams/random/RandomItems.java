...
import improving_streams.Item;

import java.util.Random;
import java.util.function.Supplier;
import java.util.stream.Stream;

import static improving_streams.random.RandomUtil.randomElement;
...
public class RandomItems {
  ...
  private Supplier<Item> itemSupplier = () -> new Item(pickAnIdentity(), pickAPrice());
